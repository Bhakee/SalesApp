...
public class MerchantDetailActivity extends CoreActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String formatted = Utility.getFormattedCurrency(selectedMerchant.getCollectionAmount());
...
//        actionBarr.setHomeButtonEnabled(true);
    ...
    protected void onResume() {
        ...
        String billListquery = "select * from bills where merchant_id = '"+selectedMerchant.getId()+"'";
    ...
    class MerchantsDetailItemListAdapter extends BaseAdapter {
        ...
        public int getCount() {
            ...
            if(paymentHistoryList != null && paymentHistoryList.size() > 0){
                listSize = listSize+paymentHistoryList.size() +1;
            }else{
                //For No Histroy to Display
                listSize = listSize+ 1 +1;
            }
        ...
        public int getItemViewType(int position) {
            ...
            if(position == 0){
                ...
                return TYPE_LIST_ITEM_HEADER;
            }else if(position >= billList.size()+2){
                return TYPE_PAYMENT_HISTORY_LIST_ITEM;
            }
                ...
                case TYPE_LIST_ITEM_HEADER:{
                    ...
                    if(holder != null) {
                        if(position == 0 ){
                            ...
                            holder.headerTitle.setText("PAYMENT HISTORY");
                        }
