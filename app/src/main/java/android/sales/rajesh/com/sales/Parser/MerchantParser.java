            ...
            try{
                ...
                for (int i = 0; i < arrayCount; i++) {
                    ...
                    if(jsonObj.has("bal")){
                        ...
                        merchantObj.setCollectionAmount(""+jsonObj.getString("bal"));
                        ...
                        if(billArray != null && billArray.length() > 0) {
                            ...
                            for (int j = 0; j < billArray.length(); j++){
                                ...
                                if(billObj != null) {
                                    ...
                                    if(billObj.has("bn")){
                                        bill.setBillingNumber(""+billObj.getInt("bn"));
                                    }
                                    ...
                                    if(billObj.has("aid")){
                                        aid = billObj.getInt("aid");

                                        bill.setAid(""+billObj.getInt("aid"));
                                    }
                                    if(billObj.has("ct")){
                                        bill.setcType(""+billObj.getString("ct"));
                                    }
                                    if(billObj.has("ba")){
                                        bill.setBillingAmount(""+billObj.getInt("ba"));
                                    }
                                    if(billObj.has("bb")){
                                        int billinBalance = billObj.getInt("bb");
                            ...
                            merchantObj.setCollectionAmount_A(""+collection_A);
                            merchantObj.setCollectionAmount_E(""+collection_E);
